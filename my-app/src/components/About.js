                ...
                <div className="accordion" id="accordionExample">
                    ...
                    <div className="accordion-item">
                        <h2 className="accordion-header">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" style={Style} data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                Accordion Item #2
                            </button>
                        </h2>
                    ...
                    <button className="btn btn-primary my-3" onClick={toggleDarkMode} value={text}>{text}</button>
                </div>
                </div>
